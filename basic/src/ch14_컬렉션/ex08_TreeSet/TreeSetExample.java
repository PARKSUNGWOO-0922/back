...
public class TreeSetExample {
	public static void main(String[] args) {
		...
		//특정 Integer 객체를 가져오기
		System.out.println("가장 낮은 점수: " + scores.first());// 최소값
		System.out.println("가장 높은 점수: " + scores.last());// 최대값
		System.out.println("95점 아래 점수: " + scores.lower(95));// 95 미만 중 가장 큰 값
		System.out.println("95점 위의 점수: " + scores.higher(95));//95 초과
		System.out.println("95점이거나 바로 아래 점수: " + scores.floor(95));// 50 이하
		System.out.println("85점이거나 바로 위의 점수: " + scores.ceiling(85) + "\n");// 50 이상
		//set.subSet(10,50);// 10 ≤ x < 50
		//set.headSet(30);// x < 30
		//set.tailSet(30);// x ≥ 30
		...
		//범위 검색( 80 <= )
		NavigableSet<Integer> rangeSet = scores.tailSet(80, true);//“80 이상(포함 true)인 모든 값들을 다 줘”
		...
		//범위 검색( 80 <= score < 90 )
		rangeSet = scores.subSet(80, true, 90, false);//subSet(시작값, 시작포함?, 끝값, 끝포함?)
		for(Integer s : rangeSet) {
			System.out.print(s + " ");
		}
	}
