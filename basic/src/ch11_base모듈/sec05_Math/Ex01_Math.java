 ...
 *   	Math.ceil(-5.3)				-5.0		->큰값으로 올림하기때문에 -5.0
 *   	Math.floor(5.3)		버림값	5.0
 *   	Math.floor(-5.3)			-6.0		->작은값으로 버림하기때문에 -6.0
 *   	Math.max(5,9)		최댓값	9			->매개변수는 2개만 가능 초과시 에러
 *   	Math.min(5.3, 2.5)	최솟값	2.5			->매개변수는 2개만 가능 초과시 에러
