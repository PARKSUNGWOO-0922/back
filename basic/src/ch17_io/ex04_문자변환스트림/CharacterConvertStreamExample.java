...
public class CharacterConvertStreamExample {
	...
	public static void write(String str) throws Exception {
		OutputStream os = new FileOutputStream("C:/sungwoo/git/back/basic/src/ch17_입출력/Temp/test5.txt");
	...
	public static String read() throws Exception {
		InputStream is = new FileInputStream("C:/sungwoo/git/back/basic/src/ch17_입출력/Temp/test5.txt");
