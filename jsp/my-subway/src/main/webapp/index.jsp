...
<body>
	<%-- 
		헤더: include 디렉티브
			// 절대 주소
		 	-> 맨 앞 /는 my-subway/src/main/webapp/
		 	
		 	// 상대 주소
		 	<img src="static/assets/img/이미지명"
	--%>
	...
	<div id="sec1" class="sec">
		<div class="vid">
			<video autoplay muted loop>
				<%-- 절대 주소 --%>
				<source src="https://subwaykr.netlify.app/assets/vid/vid.mp4"
					type="video/mp4" />
			</video>
		</div>
			...
			<div class="card-list ele-center">
				...
				<div class="card-container">
					...
					<div class="card-image-wrapper">
						<!-- https~, http~ : 절대주소 -->
						<img src="static/assets/img/bg_utilization.png"
							alt="써브웨이를 제대로 즐기는 방법" class="card-image" />
					</div>
					<!-- .card-image-wrapper -->
					<!-- card-content -->
	...
	<div id="sec3" class="sec">
		<div class="intro">
			...
			<p>
				<b>다양한 드라마</b>를<br> <strong>써브웨이</strong>와 함께 즐겨보세요
			</p>
			<p>
